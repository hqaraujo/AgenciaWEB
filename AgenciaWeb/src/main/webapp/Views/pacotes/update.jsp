...
<body>
	...
	<br><br><br><br><br>
        <header class="tag">
            <h1 class="container">Atualizar Pacotes Promocionais</h1>
        </header>

        <div class="container py-3">
            <form action="./pacotes-update" >
                <fieldset>
                    <legend>Criar
                    </legend>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="promocao" name="promocao" class="form-control"  
                    ...
                    <a href="./pacotes" class="btn btn-danger" style="margin-left: 10px">
                        Cancelar
                    </a>
                </fieldset>
            </form>
